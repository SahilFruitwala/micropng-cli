...
- Added `--size` (`-s`) flag to compress images to a specific target size or under.
- Implemented intelligent binary search for quality optimization when a target size is requested.
